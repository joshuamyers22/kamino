...
| `bundle-schema-1.3` | Recover the full stable-core prediction state: fixed rank/null-space identity, categorical random encoders, and ordered nested/crossed term maps; retain schemas 1.0–1.2 under their original contracts and keep reload prediction-only. | `docs/adr/0016-stable-core-artifact-recovery.md`; `docs/evidence/phase2-artifact-recovery.md` | 2026-09-16 |
