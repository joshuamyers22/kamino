...
| I03 likelihood profiles | SD/correlation, residual-scale, and fixed-effect trajectories against pinned lme4 2.0-6 | ML baselines, constrained objectives, signed-root deviances, adaptive intervals, ordering, and REML-to-ML provenance pass locally |
| I03 locked calibration | 1,000 predeclared regular Gaussian simulations in `statistical/i03_report.json` | Pass locally: KR rejection `0.04213` on 997 available fits; profile rejection `0.04700`, coverage `0.953`, and no unavailable profiles |
