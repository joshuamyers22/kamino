...
| `a01_postfit.json` | Kamino-owned deterministic unbalanced 2×2 factorial | ML fit outputs from pinned lme4 plus coefficient-aligned reference functions, marginal means, and pairwise adjustments from pinned emmeans 2.0.2 | Kamino MIT |
| `a02_cluster_robust.json` | Kamino-owned deterministic nested-cluster data plus derived outputs from an lme4 2.0-6 `sleepstudy` fit | CR0/CR1/CR2 covariance, working-target/adjustment/score intermediates, Satterthwaite tests, and HTZ tests from pinned clubSandwich 0.7.0 | GPL-3 development artifact; includes outputs derived from lme4's GPL-2.0-or-later dataset |
